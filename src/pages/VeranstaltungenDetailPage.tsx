...
export default function VeranstaltungenDetailPage() {
  ...
  return (
    ...
    >
      <RecordHeader title={record.fields.veranstaltungsname ?? 'Veranstaltungen'} />
      ...
      <RecordSection title="Details" cols={2}>
        ...
        <RecordField label="Veranstaltungstyp" value={record.fields.veranstaltungstyp} format="pill" />
